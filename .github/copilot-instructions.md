...
I want a similar extension setup to what homeassistant uses so the extensions are divided into types and can change the look and feel as well as the actual functionality
...
The project will have a modern and clean UI with support for light and dark mode.

The project will need to use a similar approach to homeassistant for managing extensions such as using a manifest file to define the extension and its dependencies and using a package manager to install and update extensions.
