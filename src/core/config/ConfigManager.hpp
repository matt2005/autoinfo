...
public:
    ...
    QVariant getValue(const QString& domain, const QString& extension, 
                      const QString& section, const QString& key) const;
    QVariant getValue(const QString& fullPath) const; // e.g., "core.wireless.connection.autoconnect"
    
    bool setValue(const QString& domain, const QString& extension,
    ...
    void resetItemToDefault(const QString& domain, const QString& extension,
