...
NetworkCapabilityImpl::NetworkCapabilityImpl(const QString& extension_id,
...
NetworkCapabilityImpl::~NetworkCapabilityImpl() {
    delete network_manager_;
}

QString NetworkCapabilityImpl::extensionId() const {
    return extension_id_;
}
bool NetworkCapabilityImpl::isValid() const {
    return is_valid_;
}
void NetworkCapabilityImpl::invalidate() {
    is_valid_ = false;
}
...
bool NetworkCapabilityImpl::isOnline() const {
