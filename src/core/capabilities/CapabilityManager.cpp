...
class AudioCapabilityImpl : public capabilities::AudioCapability {
  public:
    ...
    void setVolume(int playbackId, float volume) override { playback_volume_[playbackId] = volume; }
    ...
    void unsubscribe(int subscriptionId) override { state_subscribers_.remove(subscriptionId); }
